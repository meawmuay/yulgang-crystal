...
### ดาวน์โหลด
[Yulgang Crystal Version 1.0.3.4](https://github.com/meawmuay/yulgang-crystal/releases/download/v1.0.3.4/Yulgang.Crystal.rar "Yulgang Crystal Latest Version")
...
- ค่าความแม่นยำ ลูกแก้วสูง: สำหรับลูกแก้วระดับกลางที่กำลังใช้งาน เป็นค่าของการใช้ค้นหาเทียบรูปภาพ ค่าแนะนำ 0.85
